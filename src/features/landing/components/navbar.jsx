...
const Navbar = () => {
  ...
  return (
    <>
      <a className="font-bold text-6xl flex-5 justify-start pl-20 flex cursor-pointer" href="/">
        INVENT<span className="text-green-600 animate-bounce">+</span>+
      </a>
      <nav className="justify-between flex-4 2xl:pr-10 pr-4 hidden xl:flex gap-x-2">
